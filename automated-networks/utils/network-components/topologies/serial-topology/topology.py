...
def topology(args):
    ...
    net.addLink(hostA1, switches[0])
    net.addLink(hostB1, switches[1])
    net.addLink(hostB2, switches[2])
    net.addLink(hostC1, switches[3])
    net.addLink(hostC2, switches[4])
    net.addLink(hostC3, switches[4])
